...
![](../assets/img/01-docker-desktop-download.png)

### Docker Desktop のインストール

ダウンロードした `Docker Desktop Installer` を実行します。

![](../assets/img/02-win-install-docker-desktop.png)
...
![](../assets/img/03-win-install-docker-desktop-complete.png)
...
![](../assets/img/04-win-docker-subscription-service-agreement.png)

Docker Desktop が起動すると、`Welcome to Docker` 画面が表示されます。
今回は `Skip` をクリックし、スキップします。

![](../assets/img/05-win-welcome-to-docker.png)
...
![](../assets/img/06-win-power-shell-run-as-admin.png)
...
![](../assets/img/07-win-rxtools-install-component.png)
...
![](../assets/img/08-win-rxtools-install-usb-driver.png)
