...
![MADOCA-PPP 広域電離圏補正 サービス範囲[^2]](../assets/img/madoca-ppp-service-area-iono.png){#fig-madoca-ppp-iono-service-area}
...
加えて 2026-08-30 時点では、日本を覆う L6D を配信する QZS7（@tbl-qzs-has）が搭載機器の機能確認中で、**まだ信号を送信していません**[^3]。
...
各 QZS 衛星が L6 信号から配信する高精度測位サービスは @tbl-qzs-has のとおりです。
...
: 各 QZS 衛星と高精度測位サービス {#tbl-qzs-has tbl-colwidths="[22,16,46,16]"}
