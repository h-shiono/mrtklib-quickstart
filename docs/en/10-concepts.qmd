...
![MADOCA-PPP service area[^1]](../assets/img/madoca-ppp-service-area.jpg){#fig-madoca-ppp-service-area}
...
![MADOCA-PPP wide-area ionospheric correction service area[^2]](../assets/img/madoca-ppp-service-area-iono.png){#fig-madoca-ppp-iono-service-area}
...
[Quasi-Zenith Satellite System Service Level Information for Multi-GNSS Advanced Orbit and Clock Augmentation – Precise Point Positioning Technology Demonstration (Ionospehric Correction) (SLI-MDC-ION, Draft)](https://qzss.go.jp/en/technical/download/pdf/ps-is-qzss/sli-mdc-ion-draft.pdf) (February 2022)

In addition, as of 2026-08-30, QZS7 (@tbl-qzs-has), which will deliver L6D covering Japan, is undergoing on-board equipment functional checks and **is not yet transmitting a signal**[^3].
...
| **MADOCA-PPP** | QZSS satellite delivery (L6E) | QZSS visibility area (@fig-madoca-ppp-service-area) | About 30 minutes | Not required |
| **MADOCA-PPP + wide-area ionospheric correction** | QZSS satellite delivery (L6E + L6D) | Wide area (@fig-madoca-ppp-iono-service-area) | **About 10 minutes** | Not required |
: Comparison of high-precision positioning methods {#tbl-comp-pos-algorithm}
...
The high-precision positioning services delivered via the L6 signal by each QZS satellite are shown in @tbl-qzs-has.
...
: QZS satellites and their high-precision positioning services {#tbl-qzs-has tbl-colwidths="[22,16,46,16]"}
...
For the specific receiver-side configuration, see "[Appendix: Receiver Setup](80-appendix-receiver-setup.qmd)" (this is normally done automatically by `start.bat`).
