...
: Rover settings {#tbl-setup-rover}
...
## This completes the MADOCA-PPP experience 🎉 {.unnumbered}

When you're finished, follow [Shutdown (Windows)](60-stop-windows.qmd) to stop the container and detach the USB.
