...
3. **Start Docker Desktop**
    - If the logged-in user and the administrator user are different → [Run Docker Desktop as administrator](90-troubleshooting.md#sec-troubleshooting-docker-admin)
